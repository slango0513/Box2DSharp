...
namespace FixedMath
{
    public class MathFix
    {
        ...
        /// </summary>
        public static Fix64 _Abs(Fix64 value)
        {
        ...
        /// </summary>
        public static Fix64 _Sin(Fix64 x)
        {
        ...
        /// The relative error is less than 1E-10 for x in [-2PI, 2PI], and less than 1E-7 in the worst case.
        /// </summary>
        public static Fix64 _Cos(Fix64 x)
        {
            var xl = x.RawValue;
        ...
        // TODO
        public static Fix64 IEEERemainder(Fix64 radians, Fix64 fix64)
        {
            return radians % fix64;
        }
    }
}
