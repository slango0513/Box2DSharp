...
namespace FixedMath
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>, IFormattable
    {
        ...
        public static Fix64 Add(Fix64 x, Fix64 y)
        {
            var xl = x.RawValue;
            var yl = y.RawValue;
            var sum = xl + yl;
        ...
        public static Fix64 Sub(Fix64 x, Fix64 y)
        {
            var xl = x.RawValue;
            var yl = y.RawValue;
            var diff = xl - yl;
        ...
        public static Fix64 Mul(Fix64 x, Fix64 y)
        {
            var xl = x.RawValue;
            var yl = y.RawValue;
        ...
        public static Fix64 Mod(Fix64 x, Fix64 y)
        {
            return new Fix64(x.RawValue == MIN_VALUE & y.RawValue == -1 ? 0 :
